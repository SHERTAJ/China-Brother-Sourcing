      ...
      <div className="container-custom relative z-10">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-20 gap-8">
          <div className="max-w-2xl">
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-brand-navy leading-tight tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-4">
          {/* Main Large Card */}
          <div className="md:col-span-3 lg:col-span-6 bg-[#0B1D33] text-white p-10 rounded-2xl flex flex-col justify-between group">
            <div>
          ...
          {/* Side Cards */}
          <div className="md:col-span-3 lg:col-span-3 bg-slate-50 p-8 rounded-2xl border border-slate-100 hover:bg-white hover:shadow-xl transition-all">
          ...
          {/* Bottom Cards */}
          <div className="md:col-span-3 lg:col-span-4 bg-slate-50 p-8 rounded-2xl border border-slate-100 hover:bg-white hover:shadow-xl transition-all">
             <div className="mb-12 text-brand-gold">
          ...
          <div className="md:col-span-6 lg:col-span-8 bg-[#C5A059] p-10 rounded-2xl flex flex-col md:flex-row items-center gap-10 overflow-hidden relative">
